...
public class ApartmentLease extends Lease{
    LeaseDao leaseDao = new LeaseDaoImpl();
    public ApartmentLease(Tenant tenant, Property property, String startDate, String endDate, double rentAmount) {
        super(tenant, property, startDate, endDate, rentAmount);
    }

    public ApartmentLease() {}
    ...
    protected void saveLease() throws DocumentException, IOException, ParseException {
        leaseDao.addApartmentLease(this);
